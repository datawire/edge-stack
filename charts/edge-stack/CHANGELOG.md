...
- Upgrade Edge Stack chart image version to v3.9.3 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.9.2

- Upgrade Edge Stack chart image version to v3.9.2 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.9.1

- Upgrade Edge Stack chart image version to v3.9.1 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)
