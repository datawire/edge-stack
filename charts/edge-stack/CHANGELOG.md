...
- Update Edge Stack chart image to version v3.8.0-rc.0: [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)
- Update Emissary-ingress sub-chart to v3.8.0-rc.0
