...
- Update Edge Stack chart image to version v3.7.2: [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.7.1

- Update Edge Stack chart image to version v3.7.1: [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)
