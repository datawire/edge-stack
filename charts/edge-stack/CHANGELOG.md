...
- Upgrade Edge Stack chart image version to v3.12.7 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.12.6

- Upgrade Edge Stack chart image version to v3.12.6 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.12.5

- Upgrade Edge Stack chart image version to v3.12.5 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.12.4

- Upgrade Edge Stack chart image version to v3.12.4 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.12.3

- Upgrade Edge Stack chart image version to v3.12.3 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.12.2

- Upgrade Edge Stack chart image version to v3.12.2 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.12.1

- Upgrade Edge Stack chart image version to v3.12.1 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.12.0

- Upgrade Edge Stack chart image version to v3.12.0 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.11.1

- Upgrade Edge Stack chart image version to v3.11.1 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.11.0

- Upgrade Edge Stack chart image version to v3.11.0 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.10.2

- Upgrade Edge Stack chart image version to v3.10.2 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.10.1

- Upgrade Edge Stack chart image version to v3.10.1 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.10.0

- Upgrade Edge Stack chart image version to v3.10.0 [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)
...
- Update Edge Stack chart image to version v3.8.0: [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)
- Update Emissary-ingress sub-chart to v3.8.0
