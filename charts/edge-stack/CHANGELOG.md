...
- Update Edge Stack chart image to version v3.8.2: [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)

## v8.8.1

- Update Edge Stack chart image to version v3.8.1: [CHANGELOG](https://github.com/datawire/edge-stack/blob/master/CHANGELOG.md)
